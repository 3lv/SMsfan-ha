...
Integrate [Smart Fan HAT](https://sequentmicrosystems.com/products/smart-fan-for-raspberry-pi)
...
5. Add SMsfan config in configuration.yaml
    ...
    - At the end of the file append the SMsfan config:
        ```yaml
        SMsfan:
        ```
